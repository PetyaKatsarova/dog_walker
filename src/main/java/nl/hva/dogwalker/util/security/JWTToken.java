...
public class JWTToken {
    ...
    private static final String ISSUER = "Hva_dog_walking_service";
    private static final long EXPIRATIONMILLIS = 86400000; // De token verloopt over 1 dag
